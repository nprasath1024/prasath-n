  ...
  if (settings.isSplash) {
    return (
      <div>
        <HashRouter basename="/">
          <Switch>
            <Route path="/" exact render={(props) => <Splash {...props} theme={propss.theme} setTheme={propss.setTheme} />} />
            <Route path="/home" render={(props) => <Home {...props} theme={propss.theme} setTheme={propss.setTheme} />} />
            <Route path="/experience" exact render={(props) => <Experience {...props} theme={propss.theme} setTheme={propss.setTheme} />} />
    ...
    return (
      <div>
        <HashRouter basename="/">
          <Switch>
            <Route path="/" exact render={(props) => <Home {...props} theme={propss.theme} setTheme={propss.setTheme} />} />
            <Route path="/home" render={(props) => <Home {...props} theme={propss.theme} setTheme={propss.setTheme} />} />
            <Route path="/experience" exact render={(props) => <Experience {...props} theme={propss.theme} setTheme={propss.setTheme} />} />
            <Route path="/education" render={(props) => <Education {...props} theme={propss.theme} setTheme={propss.setTheme} />} />
            <Route path="/contact" render={(props) => <Contact {...props} theme={propss.theme} setTheme={propss.setTheme} />} />
